            ...
            <div class="footer-grid">
                <div class="footer-brand">
                    ...
                    <div class="footer-social">
                        <a href="https://instagram.com/brandbyuv" target="_blank" title="Instagram"><svg width="16"
                        ...
                        <a href="mailto:mail@brandbyuv.com" title="Email"><svg width="16" height="16"
                ...
                <div class="footer-col">
                    ...
                    <div class="footer-col">
                        <h4>Services</h4><a href="services.html#essential">Essential Logo</a><a
                            href="services.html#comprehensive">Brand Identity</a><a
                            href="services.html#ultimate">Ultimate
                ...
                <div class="footer-col footer-touch">
                    <h4><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            ...
                            style="vertical-align:-3px"><path
                                d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline
                                points="22,6 12,13 2,6" /></svg> Get in Touch</h4><a href="tel:+919544464144"><svg
                            width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            style="vertical-align:-2px;margin-right:4px">
                            <path
                                d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                        </svg>+91 95444 64144</a><a href="mailto:mail@brandbyuv.com"><svg width="14" height="14"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"
                            style="vertical-align:-2px;margin-right:4px">
                            <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                            <polyline points="22,6 12,13 2,6" />
                        </svg>mail@brandbyuv.com</a><a href="https://instagram.com/brandbyuv" target="_blank"><svg
                            width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            style="vertical-align:-2px;margin-right:4px">
                            <rect x="2" y="2" width="20" height="20" rx="5" ry="5" />
